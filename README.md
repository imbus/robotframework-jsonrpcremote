...
This project enables running Robot Framework keywords on a remote server, communicating via the standard JSON-RPC 2.0 protocol. It is designed to be modern, type-safe, and asynchronous.
